...
GO
/*
The type for column CreatedOn in table [dbo].[UserType] is currently  ROWVERSION NOT NULL but is being changed to  DATETIME NOT NULL. Data loss could occur.
*/
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[UserType])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_UserType] ([UserTypeID], [UserType], [CreatedOn], [CreatedBy], [ModifiedBy], [ModifiedOn])
        SELECT   [UserTypeID],
                 [UserType],
                 [CreatedOn],
                 [CreatedBy],
